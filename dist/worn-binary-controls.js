...
var mi = /* @__PURE__ */ new Set([
	...
	hash: "svelte-10olx4a",
	code: ".worn-checkbox.svelte-10olx4a {--worn-binary-boundary: color-mix(in srgb, var(--cockpit-border-strong) 30%, var(--cockpit-text-muted));position:relative;display:inline-flex;box-sizing:border-box;max-inline-size:100%;min-inline-size:44px;min-block-size:44px;align-items:center;gap:8px;vertical-align:middle;cursor:pointer;touch-action:manipulation;-webkit-tap-highlight-color:transparent;user-select:none;}.worn-checkbox.svelte-10olx4a:not(.is-labelled) {justify-content:center;}.worn-checkbox.is-disabled.svelte-10olx4a {cursor:not-allowed;}.worn-checkbox-input.svelte-10olx4a {position:absolute;z-index:1;inset:0;box-sizing:border-box;inline-size:100%;block-size:100%;margin:0;opacity:0;cursor:inherit;}.worn-checkbox-mark.svelte-10olx4a {display:flex;box-sizing:border-box;inline-size:20px;block-size:20px;flex:0 0 20px;align-items:center;justify-content:center;border:2px solid var(--worn-binary-boundary);border-radius:3px;background:var(--cockpit-surface);transition:border-color 0.12s ease, background 0.12s ease;}.worn-checkbox-input.svelte-10olx4a:checked + .worn-checkbox-mark:where(.svelte-10olx4a) {border-color:var(--worn-binary-boundary);background:var(--cockpit-accent);}.worn-checkbox.is-disabled.svelte-10olx4a .worn-checkbox-mark:where(.svelte-10olx4a) {border-color:var(--cockpit-border-strong);background:var(--cockpit-bg-secondary);}.worn-checkbox-tick.svelte-10olx4a {inline-size:10px;block-size:8px;color:var(--cockpit-accent-text);opacity:0;transform:scale(0.6);transition:opacity 0.12s ease, transform 0.12s ease;}.worn-checkbox-input.svelte-10olx4a:checked + .worn-checkbox-mark:where(.svelte-10olx4a) .worn-checkbox-tick:where(.svelte-10olx4a) {opacity:1;transform:scale(1);}.worn-checkbox-input.svelte-10olx4a:focus-visible + .worn-checkbox-mark:where(.svelte-10olx4a) {outline:2px dashed var(--cockpit-accent);outline-offset:2px;}.worn-checkbox-label.svelte-10olx4a {min-inline-size:0;overflow-wrap:anywhere;font-family:var(--font-typewriter);font-size:13px;color:var(--cockpit-text);}.worn-checkbox.is-disabled.svelte-10olx4a .worn-checkbox-label:where(.svelte-10olx4a) {color:var(--cockpit-text-muted);}\n\n  @media (prefers-reduced-motion: reduce) {.worn-checkbox-mark.svelte-10olx4a,\n    .worn-checkbox-tick.svelte-10olx4a {transition:none;}\n  }"
};
function vi(e, t) {
	Ue(t, !0), Dr(e, _i);
